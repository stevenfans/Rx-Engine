...
# john tramel 28 Feb 2017   - added .sim output for $readmemh in verilog model
#
# john tramel 29 August 2016 - renamed to trambler2.0
# john tramel 28 Feb    2017 - renamed to trambler2.1
# john tramel 07 Nov    2017 - renamed to trambler5.0.py - cleaned up opcode names
#                              SUBCY renamed to SUBC
#
...
# *.sim output - file format for file for Xilinx simulation model
#########################################################################################
